...
public class DataHandler {
    ...
    public DataHandler(Context context) {
        ...
        url = (String)settings.get(Settings.SET_SovaSERVER_URL);
    ...
    public JSONObject getDefaultATReq(){
        ...
        try {
            requestAccessObject.put("IDT", settings.get(Settings.SET_SovaSERVER_ID));
            requestAccessObject.put("Data", settings.get(Settings.SET_Sova_CRYPT_HPW));

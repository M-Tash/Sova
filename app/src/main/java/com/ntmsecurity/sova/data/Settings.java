package com.ntmsecurity.sova.data;
...
import com.ntmsecurity.sova.data.io.OldKeyIO;
import com.ntmsecurity.sova.logic.command.helper.Ringer;
import com.ntmsecurity.sova.tasks.SaveTimerTask;
...
public class Settings extends HashMap<Integer, Object> {
    ...
    public static final int SET_Sova_COMMAND = 4;
    ...
    public static final int SET_SovaSERVER_UPLOAD_SERVICE = 101;
    public static final int SET_SovaSERVER_URL = 102;
    public static final int SET_SovaSERVER_UPDATE_TIME = 103;
    public static final int SET_SovaSERVER_ID = 104;
    public static final int SET_SovaSERVER_PASSWORD_SET = 105;
    public static final int SET_SovaSERVER_LOCATION_TYPE = 106; // 0=GPS, 1=CELL, 2=ALL
    public static final int SET_SovaSERVER_AUTO_UPLOAD = 107;
    public static final int SET_Sova_CRYPT_PUBKEY = 108;
    public static final int SET_Sova_CRYPT_PRIVKEY = 109;
    public static final int SET_Sova_CRYPT_HPW = 110;
    public static final int SET_Sova_LOW_BAT_SEND = 111;

    public static final int SET_FIRST_TIME_WHITELIST = 301;
    public static final int SET_FIRST_TIME_CONTACT_ADDED = 302;
    public static final int SET_FIRST_TIME_Sova_SERVER = 303;

    public static final int SET_APP_CRASHED_LOG_ENTRY = 401;
    public static final int SET_SovaSMS_COUNTER = 402;

    public static final int SET_GPS_STATE = 501;         // 0=GPS is off 1=GPS is on 2=GPS is turned on by Sova
    ...
    public Object get(int key) {
        if (super.containsKey(key)) {
            ...
            switch (key) {
                ...
                case SET_FIRST_TIME_Sova_SERVER:
                case SET_SovaSERVER_UPLOAD_SERVICE:
                case SET_SovaSERVER_PASSWORD_SET:
                case SET_Sova_LOW_BAT_SEND:
                    return false;
                case SET_SovaSERVER_AUTO_UPLOAD:
                    return true;
                case SET_Sova_COMMAND:
                    return "sova";
                case SET_SovaSERVER_UPDATE_TIME:
                    return 60;
                case SET_INTRODUCTION_VERSION:
                case SET_SovaSMS_COUNTER:
                case SET_SovaSERVER_LOCATION_TYPE:
                case SET_SET_VERSION:
                    return 0;
                case SET_RINGER_TONE:
                    return Ringer.getDefaultRingtoneAsString();
                case SET_PIN:
                case SET_SovaSERVER_ID:
                case SET_LAST_KNOWN_LOCATION_LAT:
                case SET_LAST_KNOWN_LOCATION_LON:
                case SET_Sova_CRYPT_HPW:
                case SET_Sova_CRYPT_PRIVKEY:
                case SET_Sova_CRYPT_PUBKEY:
                    return "";
                case SET_GPS_STATE:
                    return 1;
                ...
                case SET_LAST_KNOWN_LOCATION_TIME:
                    return -1;
                case SET_SovaSERVER_URL:
                    return "https://sova.ntmsecurity.com";
            }
        }
        return "";
    }
    ...
    public Keys getKeys() {
        if (get(SET_Sova_CRYPT_PUBKEY).equals("")) {
            return null;
        } else {

            EncodedKeySpec pubKeySpec = new X509EncodedKeySpec(CypherUtils.decodeBase64((String) get(SET_Sova_CRYPT_PUBKEY)));
            ...
            return new Keys(publicKey, (String) get(SET_Sova_CRYPT_PRIVKEY));
    ...
    public void setKeys(Keys keys){
        set(SET_Sova_CRYPT_PRIVKEY, keys.getEncryptedPrivateKey());
        set(SET_Sova_CRYPT_PUBKEY, CypherUtils.encodeBase64(keys.getPublicKey().getEncoded()));
    }

    public void updateSettings() {
        if (((Integer) get(SET_SET_VERSION)) < settingsVersion && ((Integer) get(SET_INTRODUCTION_VERSION)) > 0){
            if (!((String)get(SET_SovaSERVER_ID)).isEmpty()) {
                Keys keys = OldKeyIO.readKeys();
                String HashedPW = OldKeyIO.readHashedPW();
                setKeys(keys);
                set(SET_Sova_CRYPT_HPW, HashedPW);
